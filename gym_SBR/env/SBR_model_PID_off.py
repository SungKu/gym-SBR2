...
from gym_SBR.envs import sub_phases_PID_off as cycle
import numpy as np
...
def run(WV, IV, t_ratio, influent, DO_control_par, x0, DO_setpoints):
    ...
    for cc in range(1) :
        ...
        kla0 =0# DO_control_par[5]

        t_start = t_end
        t_end = t_start + t_phs1
        t_save1, x_phs1, AE_1, ME_1 , kla_memory1, So_memory1, sp_memory1 = phs1.sim_rxn(t_start, t_end, t_delta, x0, Spar, Kpar, DO_control_par, loading, kla0)
        ...
        t_save2, x_phs2, AE_2, ME_2 , kla_memory2, So_memory2, sp_memory2 = phs2.sim_rxn(t_start, t_end, t_delta, x_phs1[-1], Spar, Kpar, DO_control_par, kla_memory1[-1])
        ...
        t_save3, x_phs3, AE_3, ME_3  , kla_memory3, So_memory3, sp_memory3 = phs3.sim_rxn(t_start, t_end, t_delta, x_phs2[-1], Spar, Kpar, DO_control_par, kla_memory2[-1])
        ...
        t_save4, x_phs4, AE_4, ME_4 , kla_memory4, So_memory4, sp_memory4 = phs4.sim_rxn(t_start, t_end, t_delta, x_phs3[-1], Spar, Kpar, DO_control_par, kla_memory3[-1])
        ...
        t_save5, x_phs5, AE_5, ME_5 , kla_memory5, So_memory5, sp_memory5 = phs5.sim_rxn(t_start, t_end, t_delta, x_phs4[-1], Spar, Kpar, DO_control_par, kla_memory4[-1])
        ...
        t_save8, x_phs8, AE_8, ME_8, kla_memory8 , So_memory8, sp_memory8 = phs8.sim_rxn(t_start, t_end, t_delta, x_phs7, Spar, Kpar, DO_control_par, kla_memory5[-1])
    ...
    return t,x,x0, kla_memory1, So_memory1, sp_memory1, t_save1, kla_memory2, So_memory2, sp_memory2, t_save2, kla_memory3, So_memory3, sp_memory3, t_save3, kla_memory4, So_memory4, sp_memory4, t_save4, kla_memory5, So_memory5, sp_memory5, t_save5, kla_memory8, So_memory8, sp_memory8, t_save8
