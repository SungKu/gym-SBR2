...
from gym_SBR.envs.module_reward_continuous_G2ANET import sbr_reward
...
class SbrOS(gym.Env):
    ...
    def reset(self):
        ...
        global t_t, x_t, u_DO_t, u_EC_t, state_t, So_t, Ss_t, Sno_t
        t_t = [0]  # time
    ...
    def get_available_actions(self, pre_action, n_agents, n_action):
        ...
        action_list = ([-0.5, 0, 0.5], [-5, 0, 5])  # ([-1, -0.5, 0, 0.5, 1],[-1, -0.5, 0, 0.5, 1])
    ...
    def step_original_backup(self, action):
        global t, u_DO, u_EC, x_out, So, Ss, Sno, Kla, EC, kla, ec, dcv_DO, ie_DO, e_DO, dcv_EC, ie_EC, e_EC, t_t, x_t, Qw, eff_component, u_DO_t, u_EC_t, state_t, So_t, Ss_t, Sno_t
    ...
    def trajectory(self, ):
        global t, u, x_out, So, Kla, kla, dcv, ie, e, t_t, x_t, Qw, eff_component, u_DO_t, u_EC_t, state_t, So_t, Ss_t, EC, Sno_t, dcv_EC, ie_EC, e_EC
        ...
        return t_t, x_t, u_DO_t, u_EC_t, state_t, So_t, Ss_t, EC, Sno_t, dcv_EC, ie_EC, e_EC

    def run_step(self, t, u_DO, u_EC, u_biomass, x_in, influent_mixed, done):  # steps for rxn phases
        global So, Ss, Sno, Kla, EC, kla, ec, dcv_DO, ie_DO, e_DO, dcv_EC, ie_EC, e_EC, t_t, x_t, Qw, eff_component, Sno_t
